...
public class RouteController {
  ...
  /*
  Following 2 bolcks are for the dependency injection(mocking)
  */
  // @Autowired
  // private final MyFileDatabase myFileDatabase;

  // @Autowired
  // public RouteController(MyFileDatabase myFileDatabase) {
  //     this.myFileDatabase = myFileDatabase;
  // }
  // private final MyFileDatabase myFileDatabase;
  ...
  public ResponseEntity<?> dropStudent(
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        Course requestedCourse = coursesMapping.get(Integer.toString(courseCode));
        boolean isStudentDropped = requestedCourse.dropStudent(courseCode);
  ...
  /** 
   * Attempts to set a student from the specified course.
   *
   * @param deptCode   A {@code String} representing the department.
   * @param courseCode  A {@code int} representing the course within the department.
   *
  ...
  /** 
  * Def of ResponseEntity.
  *
  * @param deptCode     A {@code String} representing the department.
  * @param courseCode   A {@code int} representing the course within the department.
  * @param location     A {@code String} representing the course location.
  * 
  * @return             A {@code ResponseEntity} object containing an HTTP 200.
  */
